        ...
        <div>
            ...
            <div className='mx-2 flex flex-col justify-start items-start gap-3'>
                ...
                <p className='leading-7'>
                    ...
                    <Link href="https://www.cs.cmu.edu/~rsalakhu/" underline="hover" isExternal>Ruslan Salakhutdinov</Link>. My current research interest is improving vision-language models for video understanding and as multimodal dialogue agents.
                </p>
                <p className="leading-7">
